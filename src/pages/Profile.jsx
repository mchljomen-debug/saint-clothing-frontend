...
export default function Profile() {
  ...
  const ServiceRow = ({
    ...
    return (
      <button
        type="button"
        onClick={onClick}
        className={`group flex w-full items-center gap-4 border-b border-black/10 px-5 py-5 text-left transition last:border-b-0 hover:bg-black/[0.025] ${
          isDestructive
            ? "hover:bg-red-50/50"
            : ""
        }`}
  ...
  const QuickAction = ({
    ...
    return (
      <button
        type="button"
        onClick={onClick}
        className="group flex min-h-[120px] flex-col justify-between rounded-2xl border border-black/10 bg-white/70 p-5 text-left transition duration-300 hover:-translate-y-0.5 hover:border-black/30 hover:bg-white"
      >
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-transparent px-4 pt-6 font-['Outfit']">
        <div className="mx-auto max-w-7xl">
          <div className="animate-pulse rounded-[28px] border border-black/10 bg-white/50 p-6">
  ...
  if (!token) {
    return (
      <div className="flex min-h-[70vh] items-center justify-center bg-transparent px-5 font-['Outfit']">
        <div className="w-full max-w-md rounded-[28px] border border-black/10 bg-white/70 p-8 text-center shadow-[0_20px_60px_rgba(0,0,0,0.05)] backdrop-blur-md sm:p-10">
          ...
          <p className="mx-auto mt-4 max-w-sm text-[11px] font-medium leading-6 text-gray-500">
            ...
            account details, preferences, and
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-7">
          ...
          <p className="mt-2 text-sm font-medium text-gray-500">
            Manage your Saint account, orders,
            preferences, and security.
          </p>
        </div>

        {/* ACCOUNT HERO */}
        <section className="overflow-hidden rounded-[28px] border border-black/10 bg-white/65 shadow-[0_12px_50px_rgba(0,0,0,0.04)] backdrop-blur-md">
            ...
            <div className="relative flex flex-col gap-7 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex flex-col items-center gap-5 sm:flex-row">
                ...
                <div className="text-center sm:text-left">
                  ...
                  <div className="mt-3 flex items-center justify-center gap-2 text-[11px] font-medium text-white/50 sm:justify-start">
                    <FiMail />
          ...
          {/* QUICK ACTIONS */}
          <div className="grid grid-cols-2 gap-3 border-b border-black/10 p-4 sm:grid-cols-4 sm:p-5">
            <QuickAction
              icon={FiUser}
              label="My Details"
              onClick={() =>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px]">
            ...
            <div className="min-w-0 p-5 sm:p-7 lg:p-8">
              ...
              <section className="mb-8">
                ...
                <div className="rounded-2xl border border-black/10 bg-gray-50/70 p-5">
            ...
            {/* RIGHT SIDEBAR */}
            <aside className="border-t border-black/10 bg-gray-50/50 p-5 sm:p-7 lg:border-l lg:border-t-0 lg:p-8">
          ...
          {/* FOOTER */}
          <div className="flex flex-col items-center justify-between gap-2 border-t border-black/10 px-5 py-5 sm:flex-row sm:px-8">
