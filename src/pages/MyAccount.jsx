...
export default function MyAccount(){
    ...
    const fetchPrivacyPolicy=async()=>{
      try{
        ...
        if(res.data.success){
          ...
          setPrivacyContent(Array.isArray(res.data.content)?res.data.content:[]);
        }
      }catch(error){
  ...
  const openPrivacyModal=()=>{
    ...
    setTimeout(()=>{
      ...
      if(hasNoScroll)setPrivacyScrolledToBottom(true);
    },100);
  };
  ...
  const handlePrivacyScroll=(e)=>{
    ...
    if(reachedBottom)setPrivacyScrolledToBottom(true);
  };
  ...
  const handleSave=async()=>{
    ...
    if(!acceptedPrivacy)return toast.error("Please read and accept the Data Privacy Consent first");
    ...
    try{
      ...
      if(res.data.success){
        const updatedUser={
          ...
          name:res.data.user?.name||`${firstName.trim()} ${lastName.trim()}`.trim(),
  ...
  return(
    <div className="min-h-screen bg-[#F5F4F0] pb-20 pt-8 font-['Outfit'] text-[#0A0D17] md:pt-10">
      <div className="mx-auto max-w-6xl px-4 md:px-6 lg:px-8">
          ...
          <div className="mt-2 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-xl text-sm font-semibold leading-6 text-gray-500">
                Manage your personal information, delivery address, profile photo, and account security.
              </p>
            </div>
        ...
        <div className="grid gap-5 lg:grid-cols-[300px_minmax(0,1fr)]">
          <aside className="h-fit rounded-[24px] border border-black/10 bg-white p-6 shadow-[0_8px_30px_rgba(0,0,0,0.04)] lg:sticky lg:top-6">
            <div className="flex flex-col items-center text-center">
              <div className="relative">
                <div className="h-32 w-32 overflow-hidden rounded-full border border-black/10 bg-[#F7F6F2] shadow-[0_12px_35px_rgba(0,0,0,0.08)]">
                  <img
                    src={avatarSrc}
                    alt="Profile"
              ...
              <div className="mt-5 inline-flex items-center gap-2 rounded-full border border-black/10 bg-[#F7F6F2] px-3 py-2">
              ...
              {!isEditing&&(
                <button
                  ...
                  className="mt-5 flex h-11 w-full items-center justify-center gap-2 rounded-xl bg-black text-[10px] font-black uppercase tracking-[0.18em] text-white transition hover:bg-[#222]"
                >
              ...
              {isEditing&&(
                <div className="mt-5 flex w-full items-center gap-2 rounded-xl border border-black/10 bg-[#F7F6F2] px-4 py-3">
          ...
          <main className="min-w-0 space-y-5">
            <section className="rounded-[24px] border border-black/10 bg-white p-6 shadow-[0_8px_30px_rgba(0,0,0,0.04)] md:p-7">
              <SectionHeader
            ...
            <section className="rounded-[24px] border border-black/10 bg-white p-6 shadow-[0_8px_30px_rgba(0,0,0,0.04)] md:p-7">
              ...
              <div className="mt-7 rounded-2xl border border-black/10 bg-[#F7F6F2] p-5">
                {!isEditing?(
              ...
              <section className="rounded-[24px] border border-black/10 bg-white p-6 shadow-[0_8px_30px_rgba(0,0,0,0.04)] md:p-7">
                  ...
                  {!acceptedPrivacy&&(
                    <div className="mt-4 rounded-xl border border-black/5 bg-white px-4 py-3">
                      <p className="text-[10px] font-semibold leading-5 text-gray-500">
                        Open the privacy consent, read the full document, then accept it before saving your profile changes.
                      </p>
                    </div>
                  )}
                </div>
                ...
                <div className="mt-6 flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
                  ...
                  <button
                    ...
                    className="flex h-11 items-center justify-center gap-2 rounded-xl bg-black px-7 text-[10px] font-black uppercase tracking-[0.18em] text-white transition hover:bg-[#222] disabled:cursor-not-allowed disabled:opacity-40"
                  >
                    <MdSave className="text-base"/>
                    {loading?"Saving...":!acceptedPrivacy?"Accept Privacy First":"Save Changes"}
                  </button>
                </div>
              </section>
            )}
            ...
            <section className="rounded-[24px] border border-black/10 bg-white p-6 shadow-[0_8px_30px_rgba(0,0,0,0.04)] md:p-7">
              ...
              <div className="mt-8 flex flex-col gap-4 rounded-2xl border border-black/10 bg-[#F7F6F2] p-5 sm:flex-row sm:items-center sm:justify-between">
                ...
                <button
                  ...
                  className="h-11 shrink-0 rounded-xl bg-black px-6 text-[10px] font-black uppercase tracking-[0.18em] text-white transition hover:bg-[#222] disabled:cursor-not-allowed disabled:opacity-50"
                >
      ...
      {showPrivacyModal&&(
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 px-4 py-6 backdrop-blur-[3px]">
          <div className="flex max-h-[90vh] w-full max-w-2xl flex-col overflow-hidden rounded-[26px] border border-black/10 bg-white text-[#0A0D17] shadow-[0_24px_80px_rgba(0,0,0,0.24)]">
            ...
            <div
              ...
              className="min-h-0 flex-1 overflow-y-auto bg-white px-6 py-5 md:px-7"
            >
              <div className="space-y-4">
                {privacyContent.length>0?(
                  privacyContent.map((item,index)=>(
                    <div
                      key={index}
                      className="rounded-2xl border border-black/10 bg-[#F7F6F2] p-5"
                    >
            ...
            <div className="border-t border-black/10 bg-white px-6 py-5 md:px-7">
              <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div className="flex items-center gap-2">
                  <span className={`h-2 w-2 rounded-full ${privacyScrolledToBottom?"bg-black":"bg-gray-300"}`}/>
                ...
                <div className="flex gap-3">
                  <button
                    type="button"
                    onClick={()=>setShowPrivacyModal(false)}
                    className="rounded-xl border border-black/10 bg-white px-5 py-3 text-[10px] font-black uppercase tracking-[0.16em] text-[#0A0D17] transition hover:border-black"
                  >
                    Close
                  </button>
                  ...
                  <button
                    ...
                    className="rounded-xl bg-black px-5 py-3 text-[10px] font-black uppercase tracking-[0.16em] text-white transition hover:bg-[#222] disabled:cursor-not-allowed disabled:opacity-40"
                  >
                    Accept Privacy
                  </button>
                </div>
...
const InfoField=({
  ...
  <div className="relative">
    ...
    {isEditing?(
      ...
      <div className="min-h-12 rounded-xl border border-black/5 bg-[#F7F6F2] px-4 py-3">
        <p className={`text-sm font-bold ${value?"text-[#0A0D17]":"italic text-gray-400"}`}>
          {value||"Not provided"}
        </p>
      </div>
    )}
