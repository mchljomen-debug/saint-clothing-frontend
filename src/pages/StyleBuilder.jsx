            ...
            <div className="mb-8 flex flex-col gap-4 border-b border-gray-200 pb-6 sm:flex-row sm:items-end sm:justify-between">
                ...
                <div className="flex rounded-full border border-black bg-black p-1">
                    <button
                        ...
                        className={`rounded-full px-5 py-2 text-xs font-black uppercase tracking-widest transition ${mode === "automatic"
                                ? "bg-white text-black"
                    ...
                    <button
                        ...
                        className={`rounded-full px-5 py-2 text-xs font-black uppercase tracking-widest transition ${mode === "manual"
                                ? "bg-white text-black"
                                : "text-white hover:bg-white/10"
                            }`}
                    >
                    ...
                    <div className="mb-5 flex gap-2 overflow-x-auto pb-2">
                        {CATEGORIES.map((cat) => (
                            <button
                                ...
                                className={`shrink-0 rounded-full border px-4 py-2 text-[11px] font-black uppercase tracking-widest transition ${category === cat
                        ...
                        {filteredProducts.map((item) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`group overflow-hidden rounded-[20px] border bg-white text-left transition ${active
                                ...
                                >
                                    <div className="relative aspect-[3/4] overflow-hidden bg-transparent">
                                        <img
                                            ...
                                            alt={item.name}
                                            className="h-full w-full object-contain p-2 mix-blend-multiply bg-transparent transition duration-500 group-hover:scale-105"
                                        />
                                    ...
                                    <div className="absolute left-1/2 top-[85px] h-[210px] w-[250px] -translate-x-1/2">
                                        {selectedTop ? (
                                            <img
                                                ...
                                                className="h-full w-full object-contain mix-blend-multiply bg-transparent drop-shadow-[0_18px_25px_rgba(0,0,0,0.16)]"
                                            />
                                        ) : (
                                        ...
                                        {selectedProducts.map((item) => (
                                            ...
                                            >
                                                <img
                                                    src={getProductImage(item)}
                                                    alt={item.name}
                                                    className="h-24 w-20 rounded-[16px] bg-transparent object-contain mix-blend-multiply p-1"
                                                />
