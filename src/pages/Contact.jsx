...
Questions, collaborations, wholesale inquiries or just want to say hello?
</p>
...
{["Support","Collabs","Wholesale","General"].map((item)=>(
<span
key={item}
...
<span className="shrink-0 text-[9px] font-black uppercase tracking-[0.25em] text-white/30">
PH / MNL
</span>
</div>
...
We are open to passionate creatives, developers and designers who want to help shape the future of Saint Clothing.
</p>
</div>

<div className="border-t border-white/10 p-5 md:border-l md:border-t-0 md:p-8">
<a
href="mailto:saintbrand021@gmail.com?subject=Work%20With%20Saint%20Clothing"
className="group flex w-full items-center justify-between gap-8 border border-white/20 px-6 py-4 text-[9px] font-black uppercase tracking-[0.25em] transition-all duration-300 hover:bg-white hover:text-black md:w-auto"
>
