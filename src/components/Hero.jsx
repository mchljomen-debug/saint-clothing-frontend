  ...
  const Hero=()=>{
    ...
    useEffect(()=>{
      ...
      setGreetingPrefix(
        count<=1
          ?heroData.newUserGreeting||"Welcome"
    ...
    return(
      <section
        className="hero-root relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen overflow-hidden bg-black"
          ...
          {heroData.slides.length>0?(
            ...
            >
              {heroData.slides.map((slide,index)=>{
                ...
                const image1600=optimizeCloudinaryImage(slide.image,1600);
                const image1920=optimizeCloudinaryImage(slide.image,1920);

                return(
                  <div
                    key={`${slide.title}-${index}`}
                    className="hero-slide relative w-full overflow-hidden bg-black"
                  >
                    <img
                      className="absolute inset-0 block h-full w-full object-cover"
                      src={image1600}
                      srcSet={`${image640} 640w, ${image960} 960w, ${image1280} 1280w, ${image1600} 1600w, ${image1920} 1920w`}
                      sizes="100vw"
                      alt={
                        slide.title
                          ?`${slide.title} - Saint Clothing collection`
                          :"Saint Clothing featured collection"
                      }
                      width="1920"
                      height="1080"
                      ...
                      <div className="relative max-w-4xl">
                        ...
                        {slide.subtitle&&(
                          <div className="mt-7 flex items-center gap-4">
                            <span
                              className="h-px w-12 bg-white/70"
                              aria-hidden="true"
                            />
            ...
            >
              {!heroReady&&(
                <div className="hero-placeholder-shimmer"/>
              )}
            </div>
          )}
        </div>
