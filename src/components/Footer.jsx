...
const Footer = () => {
  ...
  return (
    <footer className={`bg-[#050505] text-white ${isLoginPage ? 'mt-0' : 'mt-10'} relative overflow-hidden border-t border-white/5`}>
      <div className='h-[1px] w-full bg-gradient-to-r from-transparent via-white/20 to-transparent opacity-70' aria-hidden='true'></div>
      ...
      <div className='max-w-[1440px] mx-auto px-6 md:px-16 lg:px-24 py-8 relative z-10'>
        <div className='flex flex-col sm:grid grid-cols-[2.3fr_1fr_1.2fr] gap-6 text-sm'>
          <div className='flex flex-col gap-3 items-center sm:items-start'>
            <Link to='/' className='group flex items-center gap-4 w-fit' aria-label='Saint Clothing home'>
              <img
                src={assets.logo}
                ...
                aria-hidden='true'
              />
              <span className='font-["Outfit"] font-black text-3xl md:text-4xl tracking-[0.15em] uppercase italic text-white'>
                SAINT CLOTHING
              </span>
            </Link>
          ...
          <nav className='pt-1 text-center sm:text-left' aria-label='Footer navigation'>
            <p className='text-[11px] font-black tracking-[0.4em] text-gray-300 mb-3 uppercase'>
              Menu
            </p>

            <ul className='flex flex-col gap-2 text-gray-300 font-bold font-["Outfit"]'>
              <li>
                <Link
                  to='/'
                  className='hover:text-white transition-all duration-300 uppercase text-[10px] tracking-widest'
                >
                  Home
                </Link>
              </li>
            ...
            <ul className='flex flex-col gap-2 text-gray-300 font-bold font-["Outfit"]'>
              ...
              <li className='mt-3 flex gap-3 justify-center sm:justify-start'>
                <a
                  ...
                  aria-label='Visit Saint Clothing on Facebook'
                ...
                <a
                  ...
                  target='_blank'
                  rel='noopener noreferrer'
                  aria-label='Visit Saint Clothing on Instagram'
                ...
                <a
                  ...
                  target='_blank'
                  rel='noopener noreferrer'
                  aria-label='Visit Saint Clothing on TikTok'
